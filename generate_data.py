...
def generate_data_single_explore(params,print_simu):
...
def generate_data_parallel_single_explore(params_list,print_simu):
    """
    Generate data from a list of parameter dictionaries, parallelize the execution of each single shot simulation
    ...
    #print(params_list)
    data_parallel = Parallel(n_jobs=num_cores, verbose=10)(
        delayed(generate_data_single_explore)(i, print_simu) for i in params_list
    )
